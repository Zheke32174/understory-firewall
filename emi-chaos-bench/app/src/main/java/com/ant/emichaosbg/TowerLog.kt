...
class TowerLog(private val ctx: Context) {
    ...
    @JavascriptInterface fun start(): Boolean { running = true; return true }
    @JavascriptInterface fun stop(): Boolean { running = false; return false }
    @JavascriptInterface fun isRunning(): Boolean = running
