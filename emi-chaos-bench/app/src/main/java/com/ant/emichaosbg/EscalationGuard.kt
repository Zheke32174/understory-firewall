...
/**
 * Read-only page view. There is intentionally no method here that disables a check, clears a
 * finding, or suppresses reporting — a detector the compartment under attack can switch off is
 * not a detector.
 */
